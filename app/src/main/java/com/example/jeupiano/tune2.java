...
public class tune2 extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case (R.id.fa2):
                ...
                fa.setBackgroundResource(R.color.white);
                fa2.setBackgroundResource(R.color.black);
                AlertDialog.Builder builder = new AlertDialog.Builder(tune2.this);
                builder.setMessage("Congratulation \n you has completed the second level  \n try to play the next level");
                builder.setTitle("LEVEL 2 !");
                builder.setCancelable(false);
                builder.setPositiveButton("Yes", (DialogInterface.OnClickListener) (dialog, which) -> {
                    Intent i= new Intent(tune2.this, PianoGuideActivity.class);
                    startActivity(i);
